...
func main() {
	...
	values := SimpleMap{
		...
		"PHP_VERSION":                                   "8.0",
		"TEST_ENVIRONMENT_CE":                           "export ACTIVATE_ALL_MODULES=1 RUN_TESTS_FOR_MODULES=0 RUN_TESTS_FOR_SHOP=1 PARTIAL_MODULE_PATHS=bestit/amazonpay4oxid,oe/oepaypal,ddoe/wysiwyg,oxps/paymorrow,oe/gdproptin,fc/fcpayone,tc/tcklarna,oxps/usercentrics REMOVE_FROM_PHPUNIT=\"libpng.warning\"",
		"TEST_ENVIRONMENT_EE":                           "export ACTIVATE_ALL_MODULES=1 RUN_TESTS_FOR_MODULES=0 RUN_TESTS_FOR_SHOP=1 PARTIAL_MODULE_PATHS=bestit/amazonpay4oxid,oe/oepaypal,ddoe/visualcms,ddoe/wysiwyg,oxps/paymorrow,oe/gdproptin,fc/fcpayone,tc/tcklarna,oxps/usercentrics ADDITIONAL_TEST_PATHS=vendor/oxid-esales/oxideshop-ee/Tests,vendor/oxid-esales/oxideshop-pe/Tests REMOVE_FROM_PHPUNIT=\"libpng.warning\"",
		"TEST_ENVIRONMENT_PE":                           "export ACTIVATE_ALL_MODULES=1 RUN_TESTS_FOR_MODULES=0 RUN_TESTS_FOR_SHOP=1 PARTIAL_MODULE_PATHS=bestit/amazonpay4oxid,oe/oepaypal,ddoe/visualcms,ddoe/wysiwyg,oxps/paymorrow,oe/gdproptin,fc/fcpayone,tc/tcklarna,oxps/usercentrics ADDITIONAL_TEST_PATHS=vendor/oxid-esales/oxideshop-pe/Tests REMOVE_FROM_PHPUNIT=\"libpng.warning\"",
